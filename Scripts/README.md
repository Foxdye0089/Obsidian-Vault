...
See [`onenote-migration/README.md`](onenote-migration/README.md) for the
scripts that pull a OneNote notebook into this vault, including the
recovery workflow built for a read-only/deactivated account and every
sanitization quirk it took several rounds of bugfixes to nail down.
